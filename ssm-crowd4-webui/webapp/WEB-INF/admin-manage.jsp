...
<script type="text/javascript">
    ...
    function pageSelectCallback(pageIndex, jQuery) { // pageIndex 是当前页页码的索引，相对于 pageNum 来说，pageIndex 比 pageNum 小 1
        ...
        window.location.href = "admin/manage?pageNum="+pageNum+"&keyword=${param.keyword}";
        // 取消当前超链接的默认行为
        return false;
    }
</script>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="/admin/manage" method="post" class="form-inline" role="form" style="float:left;">
...
<%--                    <button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href=''"><i class="glyphicon glyphicon-plus"></i> 新增</button>--%>
                    <a href="admin/add" class="btn btn-primary" style="float:right;"><i class="glyphicon glyphicon-plus"></i> 新增</a>
                    <br>
                    <hr style="clear:both;">
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <c:if test="${empty requestScope.pageInfo.list }">
                                <tr>
                                    <td colspan="6" align="center">对不起，没有数据</td>
                                </tr>
                            </c:if>
                            <c:if test="${!empty requestScope.pageInfo.list }">
